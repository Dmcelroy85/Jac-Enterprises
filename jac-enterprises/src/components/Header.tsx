...
function Header() {
    return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-warning py-1 px-5">
    ...
    <div className="collapse navbar-collapse justify-content-end fs-4" id="navbarNav">
      <ul className="navbar-nav ">
        ...
        <li className="nav-item">
        <NavLink to="about"><button type="button" className="btn btn-danger btn-lg border border-3 border-primary mx-5">About</button></NavLink>
        </li>
        <li className="nav-item">
